...
UPDATE LOCATION SET LOC_RK_CODE='4040301' WHERE LOC_CITY = 'Sokoru Town' and LOC_ADDRESS = 'Sokoru Town';
...
UPDATE LOCATION SET LOC_W_CODE=70102 WHERE LOC_CITY='Abeshegei'; -- they share the same area
UPDATE LOCATION SET LOC_W_CODE=70102 WHERE LOC_CITY='Walga'; -- they share the same area
...
UPDATE LOCATION SET LOC_W_CODE=40403 WHERE LOC_CITY='Sokoru Town';
...
UPDATE LOCATION SET LOC_W_CODE=70703 WHERE LOC_CITY='Adama';

-- fixing remaining
UPDATE LOCATION SET LOC_W_CODE=40403 WHERE (LOC_CITY = 'Jimma') and (LOC_ADDRESS = 'Gibei');
UPDATE LOCATION SET LOC_W_CODE=40411 WHERE (LOC_CITY = 'Jimma') and (LOC_ADDRESS = 'Asendabo Town');
UPDATE LOCATION SET LOC_W_CODE=41314 WHERE (LOC_CITY = 'Sebeta'); -- they share the same area
UPDATE LOCATION SET LOC_W_CODE=41314 WHERE (LOC_CITY = 'Alem Gena'); -- they share the same area